...
<body>
    ...
    <section>
        <div>
            ...
            <div id="adThumbsList">
                <div>
                    <button class="view_btn1" onclick="location.href='./thumbs_create.php'">글쓰기</button>
                    <input type="text" class="searchInput" onkeyup="searchInput()" placeholder="이름 검색..">
                </div>
                <div id="includeTable">
                <table  class="imgTable sortTable"><?php include 'thumbs_select.php'; ?></table>
                </div>
                <div id="tableBox"></div>
<br>
<br>
    ...
    <script>
       function thumbsDel(str, strName) {
    let delConfirm = confirm('삭제 후 복원이 불가능합니다. 삭제하시겠습니까?');
    if(delConfirm == true) {
        location.href='./thumbs_delete.php?id='+str+'&username='+strName+'';
        alert('삭제되었습니다')
    } else {
        alert('취소되었습니다');
    }
