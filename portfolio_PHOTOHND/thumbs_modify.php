<?php    
           include 'photohnd_db_conn.php';   
                ...
                // $id = $_POST['username'];
                $q = intval($_GET['id']);
                $query = "SELECT id, username, title, img, img_dir, up_cat, low_cat FROM thumbs WHERE id= $q";
        ...
        ?>
        <form method = "POST" action = "thumbs_modify_action.php" enctype="multipart/form-data">
